    ...
    return (
        <div className='blog'>
            ...
            <div className='grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 mx-10 py-4 blog-container'>
                ...
                <div>
                    <img src={blog2} alt="" />
                    <h1 className='text-purple-500 text-xl font-semibold my-2'>What is JWT, and how does it work?</h1>
                ...
                <div>
                    <img src={blog3} alt="" />
                    <h1 className='text-purple-500 text-xl font-semibold my-2'>What is the difference between javascript and NodeJS?</h1>
                    <div>
                ...
                <div>
                    <img src={blog4} alt="" />
                    <h1 className='text-purple-500 text-xl font-semibold my-2'>How does NodeJS handle multiple requests at the same time?</h1>
